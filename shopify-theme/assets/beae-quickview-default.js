window.BEAEPAGEJS = () => { let BeaeUseHooks = {};
      try {
        let argid = 'beae-sdm2c0xvsection-js',
        ...
        args.els = document.querySelectorAll('.beae-sdm2c0xv');
        args.el = args.els[0];
  ...
  if (data.mode.value == "live") {
    ...
    if (videoContainer || videoMobileContainer) {
      window.addEventListener("resize", () => {
        ...
        console.error('BEAE JS ERROR ID beae-sdm2c0xv: ', ex)
      };
    

      try {
        let argid = 'beae-sdm2c0xvsection-featured-product',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-sdm2c0xv',
  ...
  function initValueProduct() {
    if (selectedVariant) {
      ...
      try {
        let argid = 'beae-yrjqt2qwblock-gallery',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-yrjqt2qw',
        ...
        args.els = document.querySelectorAll('.beae-yrjqt2qw');
        args.el = args.els[0];
        ((data) => { setTimeout(() => {
    ...
    data.el.querySelectorAll("button.beae-media-zoom").forEach((zoomButton) => zoomButton.addEventListener("click", (e) => {
      ...
      setTimeout(() => {
        ...
        console.error('BEAE JS ERROR ID beae-yrjqt2qw: ', ex)
      };
    

      try {
        let argid = 'beae-yrjqt2qwsection-slide-show',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-yrjqt2qw',
      ...
      try {
        let argid = 'beae-tz3j0cajblock-description',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-tz3j0caj',
        ...
        args.els = document.querySelectorAll('.beae-tz3j0caj');
        args.el = args.els[0];
        ...
        console.error('BEAE JS ERROR ID beae-tz3j0caj: ', ex)
      };
    

      try {
        let argid = 'beae-8a71crq5block-buy',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-8a71crq5',
        ...
        args.els = document.querySelectorAll('.beae-8a71crq5');
        args.el = args.els[0];
        ...
        console.error('BEAE JS ERROR ID beae-8a71crq5: ', ex)
      };
    

      try {
        let argid = 'beae-28shfi6d',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-28shfi6d',
        ...
        args.els = document.querySelectorAll('.beae-28shfi6d');
        args.el = args.els[0];
        ((data) => { const buyItNowBtn = data.el.querySelector(".shopify-payment-button__button");
          setTimeout(() => {
            const buyItNowBtn2 = data.el.querySelector(".shopify-payment-button__button", ``);
            if (buyItNowBtn2) {
              buyItNowBtn2.classList.add(data.buyItNowType);
            }
          }, 1e3); })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-28shfi6d: ', ex)
      };
